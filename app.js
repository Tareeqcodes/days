...
const formatLong = (d) => `${MONTHS[d.getMonth()]} ${d.getDate()}, ${d.getFullYear()}`;
const formatShort = (d) => `${MONTHS[d.getMonth()]} ${d.getDate()}`;
...
function render(animate) {
    ...
    const totalHours = Math.floor(msAlive / 3600000);
    ...
    if (animate)
        animateNumber(els.totalDays, totalDays);
    else
        els.totalDays.textContent = fmt(totalDays);
